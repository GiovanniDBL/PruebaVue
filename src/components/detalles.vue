...
<div class="">
    ...
    <div class="card" style="width: 30rem;">
        <!-- <router-link to="/monitoreo"> ir</router-link> -->
                        ...
                        <div class="modal-body">
                            ...
                            <form v-on:submit.prevent="PostEnviarNota">
                                <div class="mb-3">
                                    ...
                                    <textarea name="textoForm" class="form-control" v-on:change="buscar($event)" style="width:95%" placeholder="Escribir nota..." id="exampleFormControlTextarea1" rows="5" v-model="textoForm" required></textarea>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="modal-body">
                            ...
                            <form v-on:submit.prevent="PostEnviarNotaFinal">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="textoForm" class="form-control" style="width:95%" placeholder="Escribir nota..." id="exampleFormControlTextarea1" rows="5" v-model="textoFormFinal" required></textarea>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="modal-body">
                            ...
                            <form v-on:submit.prevent="AgregarNuevaNota">
                                <div class="mb-3">
                                    ...
                                    <textarea name="textoForm" class="form-control" style="width:95%" placeholder="Escribir nota..." id="exampleFormControlTextarea1" rows="5" v-model="textoFormNotaNueva" required></textarea>
                                </div>
                                <div class="mb-3">
                                    <button class="btn btn-danger" data-bs-dismiss="modal">Envíar</button>
                                </div>
